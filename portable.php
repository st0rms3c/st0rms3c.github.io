...
$site_title = 'st0rms3c.github.io';
$site_desc = 'A minimalist cybersecurity blog';
...
foreach ($files as $file) {
  ...
  $projects = '<section tabindex="0" role="document" aria-label="Projects" id="projects">'.$parsedown->text(file_get_contents('content/_extra/projects.md')).'</section>';
}
?>
<!doctype html>
<html lang="en">
...
<body>
  <header>
    <h1>
      <a href="#home" style="font-weight: bold"><?php echo $site_title; ?></a>
    </h1>
  </header>
  <main>
